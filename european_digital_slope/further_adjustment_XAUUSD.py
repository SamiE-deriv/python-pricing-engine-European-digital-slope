...
def run_backtest(
    ...
    while current_date <= end_date:
        try:
            ...
            data_path = Path("european_digital_slope/data/commodities/xauusd")
...
def create_plots(
    ...
    fig.suptitle(
        f"{month} 2024 - XAU/USD (Gold) {option_type.upper()} Options Analysis",
        fontsize=16,
    )
    ...
    ax1.set_title("XAU/USD (Gold) Spot Price and ATM Volatility")
